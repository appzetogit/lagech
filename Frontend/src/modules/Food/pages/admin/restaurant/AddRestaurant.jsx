  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (step2.profileImage instanceof File) {
        profileImageData = await handleUpload(step2.profileImage, "lagech/restaurant/profile")
      ...
      if (step3.panImage instanceof File) {
        panImageData = await handleUpload(step3.panImage, "lagech/restaurant/pan")
      ...
      if (step3.gstRegistered && step3.gstImage) {
        if (step3.gstImage instanceof File) {
          gstImageData = await handleUpload(step3.gstImage, "lagech/restaurant/gst")
      ...
      if (step3.fssaiImage instanceof File) {
        fssaiImageData = await handleUpload(step3.fssaiImage, "lagech/restaurant/fssai")
