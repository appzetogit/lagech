...
router.get('/reports/expenses', adminController.getExpenseReport);
router.get('/reports/admin-earnings', adminController.getAdminEarningReport);
router.get('/reports/items', adminController.getItemReport);
